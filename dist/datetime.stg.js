        ...
        Plugin.prototype = {
            ...
            _handleKeydown: function _handleKeydown(e) {
                ...
                var move = function move(direction) {
                    _this.currentSpareIndex = _this._calculateNextSpareIndex(_this.spares, _this.currentSpareIndex, direction, function (x) {
                ...
                switch (e.which) {
                    ...
                    case KEY_TAB:
                        if (this.options.tabControls) {
                            var previousSpareIndex = this.currentSpareIndex;
